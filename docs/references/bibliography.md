...
The 154 built-in systems cite **123 distinct sources**, grouped below by family and ordered alphabetically by first author. A handful of textbook/folklore systems (the Lissajous figures, a couple of purely illustrative maps) carry no single primary source and are omitted from this list.
...
- Anishchenko et al. (2007), Nonlinear Dynamics of Chaotic and Stochastic Systems.<br><span class="ts-cite-systems">Cited by: `AnishchenkoAstakhov`</span>
...
- Chen (1997), Proc. 1st Int. Conf. Control of Oscillations and Chaos. [doi:10.1109/coc.1997.631323](https://doi.org/10.1109/coc.1997.631323)<br><span class="ts-cite-systems">Cited by: `Chen`</span>
...
- Chua (1969), Introduction to Nonlinear Network Theory, McGraw-Hill.<br><span class="ts-cite-systems">Cited by: `Chua`</span>
...
- Decroly & Goldbeter (1982), Proc. Natl. Acad. Sci. U.S.A. 79, 6917-6921.<br><span class="ts-cite-systems">Cited by: `GlycolyticOscillation`</span>
...
- Field & Noyes (1974), J. Chem. Phys. 60, 1877-1884.<br><span class="ts-cite-systems">Cited by: `Oregonator`</span>
...
- Guckenheimer & Holmes (1983), Nonlinear Oscillations, Springer. [doi:10.1007/978-1-4612-1140-2](https://doi.org/10.1007/978-1-4612-1140-2)<br><span class="ts-cite-systems">Cited by: `GuckenheimerHolmes`</span>
...
- Houart, Dupont & Goldbeter (1999), Bull. Math. Biol. 61, 507-530.<br><span class="ts-cite-systems">Cited by: `CaTwoPlus`</span>
- Huang (2007), Int. J. Nonlinear Sci..<br><span class="ts-cite-systems">Cited by: `HyperCai`</span>
...
- Kuramoto & Tsuzuki (1976), Prog. Theor. Phys. 55, 356-369; Sivashinsky (1977), Acta Astronaut. 4, 1177-1206.<br><span class="ts-cite-systems">Cited by: `KuramotoSivashinsky`</span>
...
- Leloup, Gonze & Goldbeter (1999); Gonze, Leloup & Goldbeter (2000).<br><span class="ts-cite-systems">Cited by: `CircadianRhythm`</span>
- Letellier & Rössler (2007), Scholarpedia 2(8), 1936. [doi:10.4249/scholarpedia.1936](https://doi.org/10.4249/scholarpedia.1936)<br><span class="ts-cite-systems">Cited by: `HyperXu`, `LorenzStenflo`</span>
...
- Lü, Chen, Cheng & Čelikovský (2002), Int. J. Bifurcation Chaos 12, 2917-2926.<br><span class="ts-cite-systems">Cited by: `LuChenCheng`</span>
- Marhl & Perc (2005), Chaos Solitons Fractals 26, 909-918. [doi:10.1016/j.chaos.2005.08.013](https://doi.org/10.1016/j.chaos.2005.08.013)<br><span class="ts-cite-systems">Cited by: `HindmarshRose`</span>
- Marion (2013), Classical Dynamics of Particles and Systems.<br><span class="ts-cite-systems">Cited by: `DoublePendulum`</span>
...
- Nosé (1984), J. Chem. Phys. 81, 511-519; Hoover (1985), Phys. Rev. A 31, 1695-1697.<br><span class="ts-cite-systems">Cited by: `NoseHoover`</span>
...
- Pearson (1993), Science 261, 189-192.<br><span class="ts-cite-systems">Cited by: `GrayScott`</span>
...
- van der Pol (1926), London Edinburgh Dublin Philos. Mag. J. Sci. 2, 978-992.<br><span class="ts-cite-systems">Cited by: `ForcedVanDerPol`</span>
...
- San-Um & Srisuchinwong (2012), J. Comput..<br><span class="ts-cite-systems">Cited by: `SanUmSrisuchinwong`</span>
...
- Shaw (1981), Z. Naturforsch. A 36, 80-112.<br><span class="ts-cite-systems">Cited by: `BurkeShaw`</span>
...
- Sprott (2014), Phys. Lett. A 378, 1361-1363.<br><span class="ts-cite-systems">Cited by: `SprottTorus`</span>
...
- Sprott (2020), Chaos Theory Appl. 2, 1-3.<br><span class="ts-cite-systems">Cited by: `SprottMore`</span>
...
- Swift & Hohenberg (1977), Phys. Rev. A 15, 319-328.<br><span class="ts-cite-systems">Cited by: `SwiftHohenberg`</span>
...
- Glass & Mackey (1979), Ann. N.Y. Acad. Sci. 316, 214-235. [doi:10.1111/j.1749-6632.1979.tb29471.x](https://doi.org/10.1111/j.1749-6632.1979.tb29471.x)<br><span class="ts-cite-systems">Cited by: `MackeyGlass`</span>
...
- Tamasevicius, Mykolaitis & Bumeliene (2006), Electron. Lett. 42, 13.<br><span class="ts-cite-systems">Cited by: `PiecewiseCircuit`</span>
...
- Adler & Rivlin (1964), Proc. Amer. Math. Soc. 15, 794-796.<br><span class="ts-cite-systems">Cited by: `Chebyshev`</span>
- Arnold (1965), Amer. Math. Soc. Transl. 46, 213-284.<br><span class="ts-cite-systems">Cited by: `Circle`</span>
- Baier & Klein (1990), Phys. Lett. A 151, 281-284.<br><span class="ts-cite-systems">Cited by: `GeneralizedHenon`</span>
- Bogdanov (1981), Selecta Math. Soviet. 1, 389-421.<br><span class="ts-cite-systems">Cited by: `Bogdanov`</span>
- Chirikov (1979), Phys. Rep. 52, 263-379.<br><span class="ts-cite-systems">Cited by: `Chirikov`</span>
- Devaney (1984), Physica D 10, 387-393.<br><span class="ts-cite-systems">Cited by: `Gingerbreadman`</span>
- Dewdney (1986), Scientific American 255(3), 14-20.<br><span class="ts-cite-systems">Cited by: `Hopalong`</span>
- Dewdney (1987), Scientific American 257(1), 108-111.<br><span class="ts-cite-systems">Cited by: `DeJong`</span>
- Gumowski & Mira (1980), Recurrences and Discrete Dynamic Systems.<br><span class="ts-cite-systems">Cited by: `GumowskiMira`</span>
- Hilborn (2000), Chaos and Nonlinear Dynamics, 2nd ed. (Oxford University Press).<br><span class="ts-cite-systems">Cited by: `Gauss`</span>
- Hopf (1937), Ergodentheorie (Springer, Berlin).<br><span class="ts-cite-systems">Cited by: `Baker`</span>
- Hénon (1976), Commun. Math. Phys. 50, 69-77.<br><span class="ts-cite-systems">Cited by: `Henon`</span>
- Ikeda (1979), Opt. Commun. 30, 257-261.<br><span class="ts-cite-systems">Cited by: `Ikeda`</span>
- Kaplan & Yorke (1979), Functional Differential Equations and Approximation of Fixed Points, Lecture Notes in Mathematics 730, 204-227.<br><span class="ts-cite-systems">Cited by: `KaplanYorke`</span>
- May (1976), Nature 261, 459-467.<br><span class="ts-cite-systems">Cited by: `Logistic`</span>
- Nusse & Yorke (1994), Dynamics: Numerical Explorations.<br><span class="ts-cite-systems">Cited by: `Tinkerbell`</span>
- Pickover (1990), Computers, Pattern, Chaos and Beauty (St. Martin's Press).<br><span class="ts-cite-systems">Cited by: `Pickover`</span>
- Ricker (1954), J. Fish. Res. Board Can. 11, 559-623.<br><span class="ts-cite-systems">Cited by: `Ricker`</span>
...
- Maynard Smith (1968), Mathematical Ideas in Biology (Cambridge University Press).<br><span class="ts-cite-systems">Cited by: `MaynardSmith`</span>
...
- Zaslavsky (1978), Phys. Lett. A 69, 145-147.<br><span class="ts-cite-systems">Cited by: `Zaslavskii`</span>
- Zeraoulia & Sprott (2011), Int. J. Bifurcation Chaos 21, 155-160.<br><span class="ts-cite-systems">Cited by: `ZeraouliaSprott`</span>
...
- P. Schmelcher & F. K. Diakonos, “General approach to the localization of unstable periodic orbits in chaotic dynamical systems”, *Phys. Rev. Lett.* **78**, 4733 (1997). [doi:10.1103/PhysRevLett.78.4733](https://doi.org/10.1103/PhysRevLett.78.4733)
...
- L. Halekotte & U. Feudel, “Minimal fatal shocks in multistable complex networks”, *Sci. Rep.* **10**, 11374 (2020). [doi:10.1038/s41598-020-68200-1](https://doi.org/10.1038/s41598-020-68200-1)
