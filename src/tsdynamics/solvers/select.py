...
_ALIASES: dict[str, str] = {
    ...
    "abm": "abm4",
    "adams_moulton": "abm4",
    "adams_bashforth_moulton": "abm4",
    "predictor_corrector": "abm4",
    # explicit RK — adaptive embedded pairs
    "dopri5": "rk45",
    "dopri": "rk45",
    "dp45": "rk45",
    "dormand_prince": "rk45",
    ...
    "beuler": "backward_euler",
    "crank_nicolson": "trapezoid",
    "cn": "trapezoid",
    "trapezoidal": "trapezoid",
    "imidpoint": "implicit_midpoint",
    "gauss_legendre": "implicit_midpoint",
    "ros": "rosenbrock",
    "rosw": "rosenbrock",
