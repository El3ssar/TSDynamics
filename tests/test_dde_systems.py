...
def _mg_history(s):     return [1.5 + 0.05 * np.sin(0.1 * s)]
def _ikeda_history(s):  return [0.1 + 0.02 * np.cos(0.3 * s)]
def _sprott_history(s): return [0.5 + 0.1 * np.sin(0.2 * s)]
def _scroll_history(s): return [0.3 + 0.05 * np.cos(0.1 * s)]
def _piece_history(s):  return [0.4 + 0.05 * np.sin(0.15 * s)]
def _enso_history(s):   return [0.5 + 0.1 * np.sin(0.2 * s)]
